...
This is the code for: Towards Robust Representation Learning with Noisy Labels via Dual-Level Prototype Consistency (PyTorch implementation).
...
```
python main.py --dataset cifar10 --noise_type symmetric --noise_rate 0.4 --Lambda1 0.05 --Lambda2 0.2 --seed 1
```
